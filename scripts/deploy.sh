...
echo "👉 Restarting server via PM2 with updated environment variable..."
pm2 restart ecosystem.config.js --env development --update-env --env AWS_CLOUDFRONT_URL=$TUNNEL_URL
